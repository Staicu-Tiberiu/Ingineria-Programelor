...
public class CarsBean {
    ...
    public void createCar(String licencesPlate,String parkingSpot,Long userId)
    {
      LOG.info("createCar");
      Car car=new Car();
      car.setLicensePlate(licencesPlate);
    ...
    public CarDto findById(Long carId)
    {
        ...
        return new CarDto(carId, car.getLicensePlate(),car.getParkingSpot(), LOG.getName());
    }
